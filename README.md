...
según cumpla o no con las condiciones del lenguaje.
...
Se deberá entregar una carpeta comprimida que contenga:

1.  ✅ **Archivo ejecutable**
    -   Debe funcionar correctamente.
    -   Debe mostrar "Cadena válida" o "Cadena inválida".
2.  ✅ **Manual de usuario**
    -   Debe incluir portada.
    -   Debe contener los datos básicos de identificación.
    -   Debe explicar cómo ejecutar el programa.
...
⚠️ En caso de presentarse réplicas de archivos, estos quedarán anulados
sin oportunidad de presentar otra evidencia.
